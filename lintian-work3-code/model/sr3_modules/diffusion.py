...
class GaussianDiffusion(nn.Module):
    ...
    def p_losses(self, x_in, noise=None):
        ...
        x_recon, res_mask = self.denoise_fn(
        ...
        update_mask = x_in['mask'] + res_mask
        update_meas = torch.sum(self.shift_4d(update_mask*x_in['HR']), dim=1, keepdim=True)
        loss_mask = self.loss_func(update_meas, x_in['meas'].unsqueeze(1))
        return loss + loss_mask * 0.001

...
DAUHST_model = model_generator(opt, 'dauhst',
                               "experiments/dauhst_3stg_2024_06_19_15_48_47/model/model_epoch_203_36.47_0.957.pth").cuda()
...
optimizer = torch.optim.AdamW([
    {'params': [p for p in model.diffusion_prior.parameters() if p.requires_grad], 'lr': 3e-06}
], betas=(0.9, 0.999))
